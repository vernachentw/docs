...
> [!TIP]
>
> 1. 此份文件說明 GIPSense 主要 API 使用之入門介紹，完整 API 之使用請用戶參考 Swagger 對應文件
...
對應 GIPSense 管理平台 **監控內容設定** 功能頁，提供監控內容(如醫療人員、設備)等資料之建立、刪除等管理，並且綁定/解綁定定位標籤之操作
...
#### 3.2 以 Uid 查詢標的物: POST /rest/1.0.0/item/queryByUids
